...
class TerceiraTela : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val segundaOpcao: RadioButton = findViewById(R.id.primeiraOpcao)
        if (segundaOpcao.isChecked) {
            Dados.preco = 1
        }

        val terceiraOpcao: RadioButton = findViewById(R.id.segundaOpcao)
        if (terceiraOpcao.isChecked) {
            Dados.preco = 2
        }

        val quartaOpcao: RadioButton = findViewById(R.id.terceiraOpcao)
        if (quartaOpcao.isChecked) {
            Dados.preco = 3
        }

        val quintaOpcao: RadioButton = findViewById(R.id.quartaOpcao)
